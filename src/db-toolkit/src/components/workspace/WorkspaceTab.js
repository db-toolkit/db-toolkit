...
export function WorkspaceTab({
  ...
  return (
    <div
      ...
      className={`
        group flex items-center gap-2 px-3 py-1 cursor-pointer transition-all
        ...
        ${
          isActive
            ...
            : "bg-gray-100 dark:bg-gray-900 hover:bg-gray-200 dark:hover:bg-gray-800 border-b-transparent border-b-2"
        }
      `}
    ...
    >
      ...
      <Database
        size={14}
        className={`flex-shrink-0 ${isActive ? "text-green-600 dark:text-green-400" : "text-gray-500"}`}
      />
