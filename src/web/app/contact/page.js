  ...
  return (
    <main className="min-h-screen bg-white dark:bg-gray-900 pt-24">
      <div className="container mx-auto px-6 py-12">
        ...
        <p className="animate-fade-in-up-delay-2 text-xl text-center text-gray-600 dark:text-gray-300 mb-16 max-w-2xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-12 max-w-5xl mx-auto">
          <div className="animate-fade-in-up-delay-3">
            ...
            <div className="space-y-4">
              <div className="animate-fade-in-up-delay-4 bg-white dark:bg-gray-800 rounded-xl p-6 border border-gray-200 dark:border-gray-700 flex items-start gap-4 transition-all duration-300 hover:shadow-xl hover:scale-105 hover:-translate-y-1">
              ...
              <div className="animate-fade-in-up-delay-5 bg-white dark:bg-gray-800 rounded-xl p-6 border border-gray-200 dark:border-gray-700 flex items-start gap-4 transition-all duration-300 hover:shadow-xl hover:scale-105 hover:-translate-y-1">
              ...
              <div className="animate-fade-in-up-delay-6 bg-white dark:bg-gray-800 rounded-xl p-6 border border-gray-200 dark:border-gray-700 flex items-start gap-4 transition-all duration-300 hover:shadow-xl hover:scale-105 hover:-translate-y-1">
          ...
          <div className="animate-fade-in-up-delay-4 bg-gray-50 dark:bg-gray-800 rounded-2xl p-8 border border-gray-200 dark:border-gray-700">
            <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-6">
              Send a Message
            </h2>
            <ContactForm />
