---
title: Workspaces
description: Work with multiple databases simultaneously in isolated tabs
---
...
Workspaces allow you to work with multiple database connections simultaneously in isolated tabs. Each workspace maintains its own state including connection, queries, and active page.
